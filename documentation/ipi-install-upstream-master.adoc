...
= Deploying Installer Provisioned Infrastructure (IPI) of OpenShift on Bare Metal
...
[TIP]
====
link:index.pdf[Download] the PDF version of this document or visit https://openshift-kni.github.io/baremetal-deploy/
====
