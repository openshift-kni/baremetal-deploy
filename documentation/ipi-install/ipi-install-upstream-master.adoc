...
include::ipi-install/ipi-install-overview.adoc[leveloffset=+1]

// Prerequisites
include::ipi-install/ipi-install-prerequisites.adoc[leveloffset=+1]

// Installation Workflow
include::ipi-install/ipi-install-installation-workflow.adoc[leveloffset=+1]
