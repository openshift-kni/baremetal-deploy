...
# (Optional) Create a bond.service.
# This creates bond.service which calls roles/installer/files/customize_filesystem/{master,worker}/usr/local/bin/create-ifcfg-files.sh
# create_bond_service="true"
